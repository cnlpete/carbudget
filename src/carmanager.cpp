...
bool CarManager::backupCar(QString name)
{
    ...
    QString destination = QStandardPaths::writableLocation(QStandardPaths::DownloadLocation) + QDir::separator() + name + "_" + QDateTime::currentDateTime().toString("yyyyMMdd_HHmmss") + ".cbg";
    qDebug() << source;
    qDebug() << destination;
